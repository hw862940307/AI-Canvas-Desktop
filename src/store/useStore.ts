...
export type NodeType = 'image' | 'text' | 'prompt-engine' | 'image-gen' | 'output' | 'text-gen' | 'image-source' | 'text-source' | 'logic-engine' | 'translate-engine' | 'fusion-master' | 'spatial-view' | 'comfy_web_bridge' | 'double-box-transform';
...
export interface AppState {
  ...
  addFolder: (name: string, path?: string, parentId?: string, id?: string) => void;
...
export const useStore = create<AppState>()(
  ...
  files: [
    { id: '1', name: 'Portrait of a cat', type: 'image', url: 'https://picsum.photos/seed/cat/800/800', createdAt: Date.now() - 3600000 },
    { id: '2', name: 'Cyberpunk City', type: 'image', url: 'https://picsum.photos/seed/city/800/800', createdAt: Date.now() - 7200000 },
    { id: '3', name: 'Mountain Sunset', type: 'image', url: 'https://picsum.photos/seed/mountain/800/800', createdAt: Date.now() - 10800000 },
  ],
  folders: [
    { id: 'folder-1', name: 'Character', path: 'C:\\AI\\Assets\\Characters' },
    ...
    { id: 'folder-5', name: 'Sound Effect', path: 'C:\\AI\\Assets\\Sounds' },
    { id: 'folder-6', name: 'Others', path: 'C:\\AI\\Assets\\Misc' },
  ],
  materials: [
    { id: 'm1', name: 'Hero Character', type: 'image', url: 'https://picsum.photos/seed/hero/400/400', createdAt: Date.now(), folderId: 'folder-1' },
    { id: 'm2', name: 'Dark Forest', type: 'image', url: 'https://picsum.photos/seed/forest/400/400', createdAt: Date.now(), folderId: 'folder-2' },
  ],
  settings: {
    mouseSize: 'medium',
    theme: 'dark',
  ...
  clearFolderMaterials: (folderId) => {
    set({ materials: get().materials.filter(m => m.folderId !== folderId) });
  },
  ...
  toggleFolder: (id) => {
    set({
      folders: get().folders.map(f => f.id === id ? { ...f, isOpen: !f.isOpen } : f)
    });
  },
