...
const targetStr = `      // Realtime interactive resolution toggle - downsampling by 3x during dragging to guarantee buttery smooth 60fps!
...
if (code.includes(targetStr)) {
  ...
  console.log('Patch applied structure perfectly.');
} else {
  console.log('Did not match target block literally.');
}
